...
**Note**: This reading is also in Courses 3 and 4 of this program. If you’re taking the courses in order, you may either review it or move on to the next new course item, [Hands-On Activity: Processing time with SQL](../p1_sql-for-sparkling-clean-data/s9_hands-on_processing-time-with-sql.md).
